...
#define SWF_STSTR(msg)					FString::Printf( TEXT(#msg) TEXT("=%s, "), *ToStr(msg) )
#define SWF_STATIC_FORMAT(code,str)		FString::Printf( TEXT("%s :: [") TEXT(#code) TEXT("]"), *ToStr(str))
...
/* ----------------------------------------------------------------------------
	Failure reporting
---------------------------------------------------------------------------- */
#define SWF_FAIL(text)				appFailAssert( appToAnsi(*FString::Printf( TEXT("%s :: %s :: FAILED: ") TEXT(#text), SWF_PLOG )), __FILE__, __LINE__ );
#define SWF_FAIL_FMOD(text,msg)		appFailAssert( appToAnsi(*FString::Printf( TEXT("%s :: %s :: FAILED: ") TEXT(#text) TEXT(" FMOD: %s !"), SWF_PLOG, *ToStr(result))), __FILE__, __LINE__  );
